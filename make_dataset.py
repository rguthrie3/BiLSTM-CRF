...
def read_file(filename, w2i, t2i, mt2i):
    """
...
output = {}
output["training_instances"], output["training_vocab"] = read_file(options.training_data, w2i, t2i, mt2i)
output["dev_instances"], output["dev_vocab"] = read_file(options.dev_data, w2i, t2i, mt2i)
output["test_instances"], output["test_vocab"] = read_file(options.test_data, w2i, t2i, mt2i)

...
python model.py --dataset results/en_mtags-pos.pkl --word-embeddings --log-dir log-vit-one-onlypos-randinit-nochar-sumloss --viterbi --loss-margin one --num-epochs 20
python model.py --dataset results/en_mtags-pos.pkl --word-embeddings --log-dir log-vit-one-onlypos-randinit-char-sumloss --viterbi --use-char-rnn --loss-margin one --num-epochs 20

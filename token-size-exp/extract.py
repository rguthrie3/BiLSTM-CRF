...
with open('pg-summary.txt','w') as sum_file:
    for lg in langs:
        ...
        for dict, name in zip([dev_pos_acc_averages, dev_att_f1_averages, dev_pos_acc_stddevs, dev_att_f1_stddevs], ['POS-acc-avg','Att-F1-avg','POS-acc-std','Att-F1-std']):
